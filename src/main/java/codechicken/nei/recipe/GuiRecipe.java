...
public abstract class GuiRecipe<H extends IRecipeHandler> extends GuiContainer implements IGuiContainerOverlay,
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        ...
        fontRendererObj.drawStringWithShadow(
                String.format("m: %3s,%3s", GuiDraw.getMousePosition().x, GuiDraw.getMousePosition().y),
                0,
                -30,
                0xffffff);
        fontRendererObj.drawStringWithShadow(String.format("guiTop: %3s", guiTop), 0, -20, 0xffffff);
        fontRendererObj
                .drawStringWithShadow(String.format("hHack: %3s", (((guiTop * 2) + 176) - 176) / 2), 0, -10, 0xffffff);

        fontRendererObj.drawStringWithShadow(String.format("guiw/h: %3s,%3s", width, height), 75, -30, 0xffffff);
